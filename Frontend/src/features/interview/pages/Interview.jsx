            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    <div className="nav-content">
                        <button onClick={() => navigate('/')} className='interview-nav__item' style={{marginBottom:'0.5rem'}}>
                            <span className='interview-nav__icon'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg></span>
                            Back
                        </button>
